    ...
    <div className="min-h-screen bg-gold-100">
      ...
      >
        ...
        <div className="relative z-10">
          <p className="text-gold-400 text-xs font-display tracking-widest uppercase mb-3">Who We Are</p>
          <h1 className="font-decorative text-3xl md:text-5xl gold-text">About Us</h1>
          <div className="section-divider max-w-[100px] mx-auto mt-5" />
        </div>
      </section>

      {/* Mission */}
      <section className="py-16 px-4 bg-gold-100">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-gold-700 text-xs font-display tracking-widest uppercase mb-3">Our Mission</p>
            <h2 className="font-display text-navy-800 text-2xl md:text-3xl mb-5">Building Faith. Spreading Love. Changing Lives.</h2>
          ...
          <img
            ...
            className="rounded-sm w-full object-cover shadow-xl border border-gold-400/20"
          />
        </div>
      </section>
      ...
      <section className="bg-navy-900 py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-display text-gold-200 text-2xl md:text-3xl">Our Core Values</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={label} className="card-navy rounded-sm p-6 text-center">
                <div className="text-3xl mb-3">{icon}</div>
                <h3 className="font-display text-gold-400 text-sm tracking-widest uppercase mb-2">{label}</h3>
      ...
      <section className="bg-gold-100 py-16 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <img
            ...
            alt="Lead Pastor"
            className="rounded-sm w-full object-cover shadow-xl border border-gold-400/30 order-2 md:order-1"
          />
          <div className="order-1 md:order-2">
            <p className="text-gold-700 text-xs font-display tracking-widest uppercase mb-3">Lead Pastor</p>
            <h2 className="font-display text-navy-800 text-2xl md:text-3xl mb-2">Revd. Israel Ufuoma Erechovwe</h2>
            <p className="text-gold-600 font-display text-xs tracking-widest uppercase mb-5">Faith Believers Ministry Int'l</p>
            <p className="text-navy-700/70 leading-relaxed mb-4">
            ...
            <blockquote className="mt-6 border-l-2 border-gold-500 pl-4 italic text-navy-600/70 text-sm">
